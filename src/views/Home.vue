        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda las derivadas, esenciales en el cálculo diferencial, enfocándose en su definición e interpretación como tasas de cambio instantáneas y pendientes de rectas tangentes. Explora reglas fundamentales para derivar funciones algebraicas, trascendentes y compuestas, así como aplicaciones prácticas en administración de empresas, tales como análisis de ingresos, costos marginales y productividad. Además, profundiza en derivadas de funciones especiales y de orden superior, destacando su importancia para modelar y optimizar procesos económicos, decisiones estratégicas y dinámicas de crecimiento o decaimiento en contextos empresariales reales.
